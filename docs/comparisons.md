...
- Termyte is a local, repo-centered context system for coding agents.
...
|---|---|---|---|
| Termyte | Project context for coding agents | Replay-safe capture, authoritative task state, evidence, retrieval, and handoffs in one small runtime | Narrower scope and smaller surface area |
...
It is trying to give coding agents the project context they need, so developers do not have to repeatedly explain what happened, why, and what remains:
