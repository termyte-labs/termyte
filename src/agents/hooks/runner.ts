...
import { detectRepoId, detectWorkspaceRoot } from "../../context/retrieval/local-embeddings.js";
import { ExperienceRecorder } from "../../capture/session-recorder.js";
import { TaskDetectionService } from "../../tasks/detection.js";
