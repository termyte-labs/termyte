/**
 * Coding-domain synonym groups for query expansion.
 * Adapted from agentmemory's synonym set with Termyte-specific additions.
 *
 * When a query contains a term, we also search for its synonyms so
 * e.g. "k8s deployment" finds memories about "kubernetes".
 */
